...
* Search keyword: __"질환명[Title/Abstract]" AND "biomarker[Title/Abstract]"__
...
---- | ---- | ---- | ----
신경계 질환 | 740개 | 13,942개 | 3,773개
호흡계 질환 | 129개 | 7,144개 | 2,265개
알레르기 질환 | 28개 | 973개 | 611개
...
7. Info_KEGG: KEGG Disease Database에 해당 유전자 바이오마커 존재 시, 유전자 바이오마커 종류
8. From_DisGeNET: DisGeNET의 해당 유전자 바이오마커 포함 유무
9. Info_DisGeNET: DisGeNET에 해당 유전자 바이오마커 존재 시, 유전자 바이오마커 종류
10. From_PubMed: PubMed 문헌 검색 결과의 해당 유전자 바이오마커 포함 유무
